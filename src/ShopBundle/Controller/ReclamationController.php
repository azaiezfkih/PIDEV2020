...
class ReclamationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reclamations = $em->getRepository('ShopBundle:Reclamation')->findAll();
    ...
    {
        $deleteForm = $this->createDeleteForm($reclamation);
        $editForm = $this->createForm('ShopBundle\Form\ReclamationType', $reclamation);
     ...
     * Deletes a reclamation entity.
     *
     * @Route("/up/{id}", name="reclamation_up")
     * @Method("DELETE")
     */
    public function upAction($id)
    {
        $em=$this->getDoctrine()->getManager();
        $em->getRepository(reclamation::class)->update2DQL($id);
        $em->flush();
        return $this->redirectToRoute('reclamation_index');
    }
