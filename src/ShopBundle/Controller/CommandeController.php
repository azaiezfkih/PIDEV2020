...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $user = $this->container->get('security.token_storage')->getToken()->getUser();
       // $em=$this->getDoctrine()->getManager()->getRepository(Commande::class)->findOneBy(array('idClient'=>$prod))
        $em = $this->getDoctrine()->getManager();
        $commande_details = $em->getRepository('ShopBundle:Commande_detail')->findBy(array('idClient'=>$user));
        return $this->render('commande/index.html.twig', array(
            'commandess' => $commande_details,'commandes'=>$commandes
        ));
    }
